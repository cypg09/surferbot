export default function Homepage() {
  ...
  return (
    <div className="container place-content-center text-center text-black dark:text-white p-1  mt-12">
      <div className="grid grid-cols-6 max-w-5xl mx-auto  gap-4 lg:gap-8 place-content-center px-2">
        ...
        <div className="col-span-6 md:col-span-3 my-12">
          ...
          <ul className=" mt-8 text-black dark:text-white md:text-left font-extralight">
        ...
        <card className="col-span-6 lg:px-4 md:col-span-2  space-y-2 py-16 px-3 shadow-xl text-left dark:bg-white rounded-xl">
          <p className="text-white dark:text-black font-bold text-lg">
            Updated in real time
          </p>
          <p className="text-white dark:text-black font-extralight text-sm">
        ...
        <card className="col-span-6 lg:px-4 md:col-span-2 md:col-start-2 space-y-2 py-16 px-3 bg-gray-200 text-left dark:bg-white rounded-xl">
          <p className="text-black font-bold text-lg">
            Current profit/loss
          </p>
          <p className="text-black font-extralight text-sm">
        ...
        <card className="col-span-6 text-left lg:px-6 md:col-span-2 space-y-2 py-16 px-3 bg-gray-200 text-left dark:bg-white rounded-xl">
          <p className="text-black font-bold text-lg">
        ...
        <div className="col-span-6  w-full rounded py-20 my-20">
        ...
        <div className="col-span-6 flex place-content-center lg:col-span-1 lg:col-start-2">
          <img className="object-contain h-40 justify-self-end " src="../logo-front.png"/>
        </div>
        <div className="col-span-6 lg:col-span-2 lg:col-start-3 place-content-center text-center flex ">
        ...
        <div className="col-span-6 place-content-center text-center mb-20">
